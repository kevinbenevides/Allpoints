Vue.component("select_countries", {
    ...
    template: /*html*/ `
    <select name="countryCode" id="select_countries" v-on:change="$emit('change-value', $event.target.value)">
        ...
        <option data-countryCode="IS" value="354">+354 (Icelan)</option>
        ...
        <option data-countryCode="IE" value="353">+353 (Irelan)</option>
